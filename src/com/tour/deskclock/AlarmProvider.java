...
public class AlarmProvider extends ContentProvider {
    ...
    static {
        sURLMatcher.addURI("com.tour.deskclock", "alarm", ALARMS);
        sURLMatcher.addURI("com.tour.deskclock", "alarm/#", ALARMS_ID);
    }
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    "(hour, minutes, daysofweek, alarmtime, enabled, vibrate, message,alert,isdelete) " +
                    "VALUES ";
//            db.execSQL(insertMe + "(8, 30, 31, 0, 0, 1,0, '', '');");
//            db.execSQL(insertMe + "(9, 00, 96, 0, 0, 1,0, '', '');");
System.out.println("TourInformationActivity.clocktaglist="+TourInformationActivity.clocktaglist);
            if(TourInformationActivity.clocktaglist.size()>0){
            for(int i=0;i<TourInformationActivity.clocktaglist.size();i++){
            	db.execSQL(insertMe + "("+TourInformationActivity.clockhourlist.get(i)+","+ TourInformationActivity.clockminlist.get(i)+","+127+","+ 1+","+ 1+","+ 1+","+"'"+TourInformationActivity.clocktaglist.get(i)+"'"+", '',0);");
            }
            }else{
//	          db.execSQL(insertMe + "(6, 00, 127, 0, 1, 1,  '', '',0);");
//	          db.execSQL(insertMe + "(12, 00, 127, 0, 1, 1,  '', '',0);");
//	          db.execSQL(insertMe + "(19, 00, 127, 0, 1, 1,  '', '',0);");	
